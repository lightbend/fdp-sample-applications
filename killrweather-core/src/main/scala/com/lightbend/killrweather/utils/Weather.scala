...
object Weather {
  ...
  case class DailyWeatherData(wsid: String, year: Int, month: Int, day: Int, high: Double, low: Double, mean: Double,
        stdev: Double, variance: Double, precip: Double) extends Serializable
