...
class CassandraRawSink(sqlContext: SQLContext) extends Sink {
  ...
  override def addBatch(batchId: Long, df: DataFrame) = {
    ...
    ds.rdd.saveToCassandra(CassandraKeyspace, CassandraTableRaw)
  }
}
...
class CassandraDailySink(sqlContext: SQLContext) extends Sink {
  ...
  */
  override def addBatch(batchId: Long, df: DataFrame) = {
    ...
    temp.rdd.saveToCassandra(CassandraKeyspace, CassandraTableDailyTemp,
    ...
    pressure.rdd.saveToCassandra(CassandraKeyspace, CassandraTableDailyPressure,
    ...
    wind.rdd.saveToCassandra(CassandraKeyspace, CassandraTableDailyWind,
    ...
    precip.rdd.saveToCassandra(CassandraKeyspace, CassandraTableDailyPrecip,
...
class CassandraMonthlySink(sqlContext: SQLContext) extends Sink {
  ...
  */
  override def addBatch(batchId: Long, df: DataFrame) = {
    ...
    temp.rdd.saveToCassandra(CassandraKeyspace, CassandraTableMonthlyTemp,
    ...
    pressure.rdd.saveToCassandra(CassandraKeyspace, CassandraTableMonthlyPressure,
    ...
    wind.rdd.saveToCassandra(CassandraKeyspace, CassandraTableMonthlyWind,
    ...
    precip.rdd.saveToCassandra(CassandraKeyspace, CassandraTableMonthlyPrecip,
